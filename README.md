...
## Experience
#### 🔭July 2022 – Jan 2023 : UBION CORPORATION - Data Scientist Trainee @Seoul, S.Korea 
...
• Engineered machine learning models to identify investment opportunities by analyzing market trends and user data, improving investment prediction accuracy.\
• Collaborated with fintech startups to optimize algorithms, resulting in enhanced system efficiency, and reduced operational cost by 20%.
    
#### 🔭Dec 2020 – May 2022 : HANA FINANCIAL INVESTMENT - Senior Market Analyst  @Seoul, S.Korea 
• Led data-centric projects to enhance client engagement, using associate rules for personalized brokerage discounts, enhancing cross-departmental collaboration and increased user engagement by 80%.\
• Delivered comprehensive quantitative market research and performance analytics to high-value retail clients, ensuring data-driven decision-making and contributing transaction fee reduction by 60%.\
...
• Designed and implemented data-driven commodity derivatives hedging strategies, utilizing quantitative
analysis to meet institutional client’s risk management and position optimization goals.\
...
• Leveraged data analytics and predictive modeling to enhance client communication and retention strategies, streamline the onboarding process, and produce insightful, dashboard reports for institutional clients.\
